...
public class KidsWithTheGreatestNumberOfCandies {
    ...
    public static void main(String... args) {
        ...
        int extraCandies = 3;
        log.info("Candies : [{}] & extraCandies : {} -> {}", candies, extraCandies, kidsWithCandies(candies, extraCandies));
    ...
    public static List<Boolean> kidsWithCandies(int[] candies, int extraCandies) {
        ...
        int maxCandiesWithKid = IntStream.of(candies).max().getAsInt();;
        List<Boolean> kidWithCandies = new ArrayList<>(candies.length);
        for (Integer kidsCandies : candies) {
            boolean b = kidsCandies + extraCandies >= maxCandiesWithKid ? kidWithCandies.add(true) : kidWithCandies.add(false);
        }
