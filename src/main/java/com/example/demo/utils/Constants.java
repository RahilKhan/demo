...
public final class Constants {
	...
	public static final String POG_GUIDE_ZIP_FILE = "PogSetupGuide.zip";
	public static final String POG_GUIDE_PDF_FILE = "PogSetupGuide.pdf";
	public static final String POG_GUIDE_CSV_FILE = "PogSetupGuide.csv";
